...
def create_parser():
    ...
    parser.add_argument('--path', type = str, default = '/home/cs504322/homeworks/HW3/results',help = 'Provide path to the result file')
    parser.add_argument('--base', type = str, default = 'bmi_*results.pkl', help= 'Provide Filename structure, may use * for wildcard')
    parser.add_argument('--shallow_path', type = str, default = '/home/cs504322/homeworks/HW3/results/shallow/run2/', help= 'Provide Path to Shallow Network')
    parser.add_argument('--deep_path', type = str, default = '/home/cs504322/homeworks/HW3/results/deep/run2/', help= 'Provide path to Deep Network')
...
def plot_results(epochs = None, data1 = None, data2 = None, data3 = None, data4 = None, data5 = None, xlabel = None, ylabel= None, title = None):
    ...
    plt.savefig("plots/Fig_%s.png"%title)
