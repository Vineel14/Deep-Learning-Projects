...
def create_parser():
    ...
    parser.add_argument('--path', type = str, default = '/home/cs504322/homeworks/HW6/results',help = 'Provide path to the result file')
    ...
    parser.add_argument('--gru_path', type = str, default = '/home/cs504322/homeworks/HW6/results/gru/run1', help= 'Provide path to GRU Network')
    parser.add_argument('--mha_path', type = str, default = '/home/cs504322/homeworks/HW6/results/mha/run1', help= 'Provide path to MHA Network')
...
if __name__ == "__main__":
  ...
  We are plotting a total of 3 figures here 
    ...
    4.  Scatter plot of the number of training epochs.
