...
from keras.layers import GlobalMaxPooling2D, AveragePooling3D, AveragePooling1D, AveragePooling2D,GlobalMaxPooling1D
...
def create_mha_network(
    ...
    print("previous layer shape",x.shape)

    # Add a positional encoding layer
    pos_encoding_layer = PositionalEncoding(max_steps=len_max, max_dims=n_embeddings, combination_type='add')
