...
def exp_type_to_hyperparameters(args):
    ...
    if args.exp_type == 'bmi':
        # _TODO
        p = {'Ntraining': [1,2,4,6,9,13,18], 
             'rotation': [i for i in range(20) if i % 2 == 0],
             'L1_regularization': [10, 0.001, 0.0001, 0.00001, 0.000001],
             }
    else: 
...
def execute_exp(args=None):
    ...
    # Metrics
    fvaf = FractionOfVarianceAccountedFor(outs_training.shape[1])
...
def create_parser():
    '''
    You will only use some of the arguments for HW2
    '''
    ...
    # WandB
    parser.add_argument('--project', type=str, default='HW2', help='WandB project name')
